package com.christzhang.customwidgets;
...
public class Customtimeout extends android.support.v7.widget.AppCompatTextView {
    //TODO 圆实心的颜色
    ...
    public Customtimeout(Context context) {
        super(context);
        init();
    }
     ...
     *@param attrs
     */
    public Customtimeout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
