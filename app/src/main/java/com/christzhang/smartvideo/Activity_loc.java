...
import com.christzhang.bean.LocalVideoBean;
import com.christzhang.player.GetLocalVideosTask;
import com.christzhang.player.LocalVideoListAdapter;
import com.christzhang.player.PlayerActivity;
import com.christzhang.title.TitleBuilder;
import com.christzhang.util.PermissionUtils;
import com.christzhang.util.ScreenUtils;
import com.christzhang.view.stateview.StateView;

import java.util.ArrayList;
import java.util.List;

public class Activity_loc extends AppCompatActivity implements
    ...
    private void initListener() {
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1,
                ...
                Intent intent = new Intent(Activity_loc.this, PlayerActivity.class);
...
//				// 当开始滑动且ListView底部的Y轴点超出屏幕最大范围时，显示或隐藏顶部按钮
                ...
                if (height >= 1.5 * ScreenUtils.getScreenHeight(Activity_loc.this)) {
